...
constexpr PackedEnumMap<Feature, const char *> kFeatureNames = {{
    ...
    {Feature::AllocateNonZeroTextures, "allocateNonZeroTextures"},
    ...
    {Feature::AvoidComplexExpressionsInStructConstructor, "avoidComplexExpressionsInStructConstructor"},
    ...
    {Feature::DisableClearTexture, "disableClearTexture"},
    ...
    {Feature::LimitMaxBufferBytesTo1MB, "limitMaxBufferBytesTo1MB"},
    ...
    {Feature::LimitMaxTextureBytesTo1MB, "limitMaxTextureBytesTo1MB"},
    {Feature::LimitMaxVisibilityQueryOffset, "limitMaxVisibilityQueryOffset"},
    {Feature::LimitOutputVaryingsTo256AtCompileTime, "limitOutputVaryingsTo256AtCompileTime"},
    ...
    {Feature::LoseHardenedContextOnBackendError, "loseHardenedContextOnBackendError"},
    ...
    {Feature::SetNeedInitOnInvalidation, "setNeedInitOnInvalidation"},
    ...
    {Feature::SupportsAstc3d, "supportsAstc3d"},
    ...
    {Feature::SupportsClKhrSubgroups, "supportsClKhrSubgroups"},
    ...
    {Feature::SupportsTileMemoryHeap, "supportsTileMemoryHeap"},
    ...
    {Feature::UseIr, "useIr"},
    {Feature::UseLargeSizeForDynamicBuffers, "useLargeSizeForDynamicBuffers"},
    ...
    {Feature::ValidateState, "validateState"},
