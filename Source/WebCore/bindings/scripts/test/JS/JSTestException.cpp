...
{
    auto* structure = JSTestExceptionPrototype::createStructure(vm, &globalObject, WebCore::storedPrototypeObject(globalObject.errorStructure()));
...
JSTestExceptionOwner::JSTestExceptionOwner(ClangVTableWorkaroundTag) { }
