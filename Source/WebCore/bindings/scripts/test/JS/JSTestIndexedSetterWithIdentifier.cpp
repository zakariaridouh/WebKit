...
static const std::array<HashTableValue, 2> JSTestIndexedSetterWithIdentifierPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsTestIndexedSetterWithIdentifierConstructor, 0 } },
    HashTableValue { "indexedSetter"_s, static_cast<unsigned>(JSC::PropertyAttribute::Function), NoIntrinsic, { HashTableValue::NativeFunctionType, jsTestIndexedSetterWithIdentifierPrototypeFunction_indexedSetter, 2 } },
};
...
JSC::Structure* JSTestIndexedSetterWithIdentifierPrototype::createStructure(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::JSValue prototype)
{
...
JSTestIndexedSetterWithIdentifier::JSTestIndexedSetterWithIdentifier(Structure* structure, JSDOMGlobalObject& globalObject, Ref<TestIndexedSetterWithIdentifier>&& impl)
    : JSDOMWrapper<TestIndexedSetterWithIdentifier>(structure, globalObject, WTF::move(impl))
{
}
...
JSTestIndexedSetterWithIdentifier* JSTestIndexedSetterWithIdentifier::create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<TestIndexedSetterWithIdentifier>&& impl)
{
    auto& vm = globalObject->vm();
    JSTestIndexedSetterWithIdentifier* ptr = new (NotNull, JSC::allocateCell<JSTestIndexedSetterWithIdentifier>(vm)) JSTestIndexedSetterWithIdentifier(structure, *globalObject, WTF::move(impl));
    ptr->finishCreation(vm);
    return ptr;
}
...
{
    return getDOMConstructor<JSTestIndexedSetterWithIdentifierDOMConstructor, DOMConstructorID::TestIndexedSetterWithIdentifier>(vm, *uncheckedDowncast<JSDOMGlobalObject>(globalObject));
}
...
bool JSTestIndexedSetterWithIdentifier::legacyPlatformObjectGetOwnProperty(JSObject* object, JSGlobalObject* lexicalGlobalObject, PropertyName propertyName, PropertySlot& slot, bool ignoreNamedProperties)
{
    ...
    auto* thisObject = uncheckedDowncast<JSTestIndexedSetterWithIdentifier>(object);
...
void JSTestIndexedSetterWithIdentifier::getOwnPropertyNames(JSObject* object, JSGlobalObject* lexicalGlobalObject, PropertyNameArrayBuilder& propertyNames, DontEnumPropertiesMode mode)
{
    auto& vm = JSC::getVM(lexicalGlobalObject);
    auto* thisObject = uncheckedDowncast<JSTestIndexedSetterWithIdentifier>(object);
...
{
    auto* thisObject = uncheckedDowncast<JSTestIndexedSetterWithIdentifier>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, info());
...
JSTestIndexedSetterWithIdentifierOwner::JSTestIndexedSetterWithIdentifierOwner(ClangVTableWorkaroundTag) { }
...
void JSTestIndexedSetterWithIdentifierOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    SUPPRESS_UNCOUNTED_ARG uncacheWrapper(world, &jsTestIndexedSetterWithIdentifier->wrapped(), jsTestIndexedSetterWithIdentifier);
}
...
#endif
template<std::same_as<TestIndexedSetterWithIdentifier> T>
static inline void verifyVTable(TestIndexedSetterWithIdentifier* ptr)
{
...
JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, Ref<TestIndexedSetterWithIdentifier>&& impl)
{
    UNUSED_PARAM(lexicalGlobalObject);
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<TestIndexedSetterWithIdentifier>(impl.ptr());
#endif
    return createWrapper<TestIndexedSetterWithIdentifier>(globalObject, WTF::move(impl));
}
