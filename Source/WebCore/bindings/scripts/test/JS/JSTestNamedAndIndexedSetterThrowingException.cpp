...
JSC::Structure* JSTestNamedAndIndexedSetterThrowingExceptionPrototype::createStructure(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::JSValue prototype)
{
...
JSTestNamedAndIndexedSetterThrowingException::JSTestNamedAndIndexedSetterThrowingException(Structure* structure, JSDOMGlobalObject& globalObject, Ref<TestNamedAndIndexedSetterThrowingException>&& impl)
    : JSDOMWrapper<TestNamedAndIndexedSetterThrowingException>(structure, globalObject, WTF::move(impl))
{
}
...
JSTestNamedAndIndexedSetterThrowingException* JSTestNamedAndIndexedSetterThrowingException::create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<TestNamedAndIndexedSetterThrowingException>&& impl)
{
    auto& vm = globalObject->vm();
    JSTestNamedAndIndexedSetterThrowingException* ptr = new (NotNull, JSC::allocateCell<JSTestNamedAndIndexedSetterThrowingException>(vm)) JSTestNamedAndIndexedSetterThrowingException(structure, *globalObject, WTF::move(impl));
    ptr->finishCreation(vm);
    return ptr;
}
...
{
    return getDOMConstructor<JSTestNamedAndIndexedSetterThrowingExceptionDOMConstructor, DOMConstructorID::TestNamedAndIndexedSetterThrowingException>(vm, *uncheckedDowncast<JSDOMGlobalObject>(globalObject));
}
...
bool JSTestNamedAndIndexedSetterThrowingException::legacyPlatformObjectGetOwnProperty(JSObject* object, JSGlobalObject* lexicalGlobalObject, PropertyName propertyName, PropertySlot& slot, bool ignoreNamedProperties)
{
    ...
    auto* thisObject = uncheckedDowncast<JSTestNamedAndIndexedSetterThrowingException>(object);
...
void JSTestNamedAndIndexedSetterThrowingException::getOwnPropertyNames(JSObject* object, JSGlobalObject* lexicalGlobalObject, PropertyNameArrayBuilder& propertyNames, DontEnumPropertiesMode mode)
{
    auto& vm = JSC::getVM(lexicalGlobalObject);
    auto* thisObject = uncheckedDowncast<JSTestNamedAndIndexedSetterThrowingException>(object);
...
{
    auto* thisObject = uncheckedDowncast<JSTestNamedAndIndexedSetterThrowingException>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, info());
...
JSTestNamedAndIndexedSetterThrowingExceptionOwner::JSTestNamedAndIndexedSetterThrowingExceptionOwner(ClangVTableWorkaroundTag) { }
...
void JSTestNamedAndIndexedSetterThrowingExceptionOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    SUPPRESS_UNCOUNTED_ARG uncacheWrapper(world, &jsTestNamedAndIndexedSetterThrowingException->wrapped(), jsTestNamedAndIndexedSetterThrowingException);
}
...
#endif
    return createWrapper<TestNamedAndIndexedSetterThrowingException>(globalObject, WTF::move(impl));
}
