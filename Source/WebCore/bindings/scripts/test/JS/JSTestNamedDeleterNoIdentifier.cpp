...
static const std::array<HashTableValue, 1> JSTestNamedDeleterNoIdentifierPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsTestNamedDeleterNoIdentifierConstructor, 0 } },
};
...
JSC::Structure* JSTestNamedDeleterNoIdentifierPrototype::createStructure(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::JSValue prototype)
{
...
JSTestNamedDeleterNoIdentifier::JSTestNamedDeleterNoIdentifier(Structure* structure, JSDOMGlobalObject& globalObject, Ref<TestNamedDeleterNoIdentifier>&& impl)
    : JSDOMWrapper<TestNamedDeleterNoIdentifier>(structure, globalObject, WTF::move(impl))
{
}
...
{
    return getDOMConstructor<JSTestNamedDeleterNoIdentifierDOMConstructor, DOMConstructorID::TestNamedDeleterNoIdentifier>(vm, *uncheckedDowncast<JSDOMGlobalObject>(globalObject));
}
...
void JSTestNamedDeleterNoIdentifier::getOwnPropertyNames(JSObject* object, JSGlobalObject* lexicalGlobalObject, PropertyNameArrayBuilder& propertyNames, DontEnumPropertiesMode mode)
{
    auto& vm = JSC::getVM(lexicalGlobalObject);
    auto* thisObject = uncheckedDowncast<JSTestNamedDeleterNoIdentifier>(object);
...
JSTestNamedDeleterNoIdentifierOwner::JSTestNamedDeleterNoIdentifierOwner(ClangVTableWorkaroundTag) { }
...
void JSTestNamedDeleterNoIdentifierOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    SUPPRESS_UNCOUNTED_ARG uncacheWrapper(world, &jsTestNamedDeleterNoIdentifier->wrapped(), jsTestNamedDeleterNoIdentifier);
}
...
#endif
    return createWrapper<TestNamedDeleterNoIdentifier>(globalObject, WTF::move(impl));
}
