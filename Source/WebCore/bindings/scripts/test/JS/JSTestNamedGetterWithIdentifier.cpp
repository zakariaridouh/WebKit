...
JSC::Structure* JSTestNamedGetterWithIdentifierPrototype::createStructure(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::JSValue prototype)
{
...
JSTestNamedGetterWithIdentifier::JSTestNamedGetterWithIdentifier(Structure* structure, JSDOMGlobalObject& globalObject, Ref<TestNamedGetterWithIdentifier>&& impl)
    : JSDOMWrapper<TestNamedGetterWithIdentifier>(structure, globalObject, WTF::move(impl))
{
}
...
JSTestNamedGetterWithIdentifier* JSTestNamedGetterWithIdentifier::create(JSC::Structure* structure, JSDOMGlobalObject* globalObject, Ref<TestNamedGetterWithIdentifier>&& impl)
{
...
{
    return getDOMConstructor<JSTestNamedGetterWithIdentifierDOMConstructor, DOMConstructorID::TestNamedGetterWithIdentifier>(vm, *uncheckedDowncast<JSDOMGlobalObject>(globalObject));
}
...
void JSTestNamedGetterWithIdentifier::getOwnPropertyNames(JSObject* object, JSGlobalObject* lexicalGlobalObject, PropertyNameArrayBuilder& propertyNames, DontEnumPropertiesMode mode)
{
    auto& vm = JSC::getVM(lexicalGlobalObject);
    auto* thisObject = uncheckedDowncast<JSTestNamedGetterWithIdentifier>(object);
...
{
    auto* thisObject = uncheckedDowncast<JSTestNamedGetterWithIdentifier>(cell);
    ASSERT_GC_OBJECT_INHERITS(thisObject, info());
...
JSC_DEFINE_CUSTOM_GETTER(jsTestNamedGetterWithIdentifierConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    auto& vm = JSC::getVM(lexicalGlobalObject);
    auto throwScope = DECLARE_THROW_SCOPE(vm);
    auto* prototype = dynamicDowncast<JSTestNamedGetterWithIdentifierPrototype>(JSValue::decode(thisValue));
    if (!prototype) [[unlikely]]
        return throwVMTypeError(lexicalGlobalObject, throwScope);
    return JSValue::encode(JSTestNamedGetterWithIdentifier::getConstructor(vm, prototype->realm()));
}
...
JSTestNamedGetterWithIdentifierOwner::JSTestNamedGetterWithIdentifierOwner(ClangVTableWorkaroundTag) { }
...
void JSTestNamedGetterWithIdentifierOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    SUPPRESS_UNCOUNTED_ARG uncacheWrapper(world, &jsTestNamedGetterWithIdentifier->wrapped(), jsTestNamedGetterWithIdentifier);
}
...
#endif
template<std::same_as<TestNamedGetterWithIdentifier> T>
static inline void verifyVTable(TestNamedGetterWithIdentifier* ptr)
{
...
JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, Ref<TestNamedGetterWithIdentifier>&& impl)
{
    UNUSED_PARAM(lexicalGlobalObject);
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<TestNamedGetterWithIdentifier>(impl.ptr());
#endif
    return createWrapper<TestNamedGetterWithIdentifier>(globalObject, WTF::move(impl));
}
...
{
    if (auto* wrapper = dynamicDowncast<JSTestNamedGetterWithIdentifier>(value))
