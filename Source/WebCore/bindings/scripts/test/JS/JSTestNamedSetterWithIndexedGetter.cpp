...
static const std::array<HashTableValue, 3> JSTestNamedSetterWithIndexedGetterPrototypeTableValues {
    HashTableValue { "constructor"_s, static_cast<unsigned>(PropertyAttribute::DontEnum), NoIntrinsic, { HashTableValue::GetterSetterType, jsTestNamedSetterWithIndexedGetterConstructor, 0 } },
    HashTableValue { "namedSetter"_s, static_cast<unsigned>(JSC::PropertyAttribute::Function), NoIntrinsic, { HashTableValue::NativeFunctionType, jsTestNamedSetterWithIndexedGetterPrototypeFunction_namedSetter, 2 } },
    HashTableValue { "indexedSetter"_s, static_cast<unsigned>(JSC::PropertyAttribute::Function), NoIntrinsic, { HashTableValue::NativeFunctionType, jsTestNamedSetterWithIndexedGetterPrototypeFunction_indexedSetter, 1 } },
};
...
JSC::Structure* JSTestNamedSetterWithIndexedGetterPrototype::createStructure(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::JSValue prototype)
{
...
JSTestNamedSetterWithIndexedGetter::JSTestNamedSetterWithIndexedGetter(Structure* structure, JSDOMGlobalObject& globalObject, Ref<TestNamedSetterWithIndexedGetter>&& impl)
    : JSDOMWrapper<TestNamedSetterWithIndexedGetter>(structure, globalObject, WTF::move(impl))
{
}
...
{
    return getDOMConstructor<JSTestNamedSetterWithIndexedGetterDOMConstructor, DOMConstructorID::TestNamedSetterWithIndexedGetter>(vm, *uncheckedDowncast<JSDOMGlobalObject>(globalObject));
}
...
JSC_DEFINE_CUSTOM_GETTER(jsTestNamedSetterWithIndexedGetterConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSTestNamedSetterWithIndexedGetter::getConstructor(vm, prototype->realm()));
}
...
{
    return WebCore::subspaceForImpl<JSTestNamedSetterWithIndexedGetter, UseCustomHeapCellType::No>(vm, "JSTestNamedSetterWithIndexedGetter"_s,
...
JSTestNamedSetterWithIndexedGetterOwner::JSTestNamedSetterWithIndexedGetterOwner(ClangVTableWorkaroundTag) { }
...
void JSTestNamedSetterWithIndexedGetterOwner::finalize(JSC::Handle<JSC::Unknown> handle, void* context)
{
    ...
    SUPPRESS_UNCOUNTED_ARG uncacheWrapper(world, &jsTestNamedSetterWithIndexedGetter->wrapped(), jsTestNamedSetterWithIndexedGetter);
}
...
#endif
    return createWrapper<TestNamedSetterWithIndexedGetter>(globalObject, WTF::move(impl));
}
...
{
    if (auto* wrapper = dynamicDowncast<JSTestNamedSetterWithIndexedGetter>(value))
