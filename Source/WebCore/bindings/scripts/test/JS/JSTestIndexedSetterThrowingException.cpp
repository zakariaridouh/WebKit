...
JSC::Structure* JSTestIndexedSetterThrowingExceptionPrototype::createStructure(JSC::VM& vm, JSC::JSGlobalObject* globalObject, JSC::JSValue prototype)
{
...
JSTestIndexedSetterThrowingException::JSTestIndexedSetterThrowingException(Structure* structure, JSDOMGlobalObject& globalObject, Ref<TestIndexedSetterThrowingException>&& impl)
    : JSDOMWrapper<TestIndexedSetterThrowingException>(structure, globalObject, WTF::move(impl))
{
}
...
{
    return getDOMConstructor<JSTestIndexedSetterThrowingExceptionDOMConstructor, DOMConstructorID::TestIndexedSetterThrowingException>(vm, *uncheckedDowncast<JSDOMGlobalObject>(globalObject));
}
...
JSC_DEFINE_CUSTOM_GETTER(jsTestIndexedSetterThrowingExceptionConstructor, (JSGlobalObject* lexicalGlobalObject, EncodedJSValue thisValue, PropertyName))
{
    ...
    return JSValue::encode(JSTestIndexedSetterThrowingException::getConstructor(vm, prototype->realm()));
}
...
JSC::JSValue toJSNewlyCreated(JSC::JSGlobalObject* lexicalGlobalObject, JSDOMGlobalObject* globalObject, Ref<TestIndexedSetterThrowingException>&& impl)
{
    UNUSED_PARAM(lexicalGlobalObject);
#if ENABLE(BINDING_INTEGRITY)
    verifyVTable<TestIndexedSetterThrowingException>(impl.ptr());
#endif
    return createWrapper<TestIndexedSetterThrowingException>(globalObject, WTF::move(impl));
}
...
{
    if (auto* wrapper = dynamicDowncast<JSTestIndexedSetterThrowingException>(value))
